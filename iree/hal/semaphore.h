...
class Semaphore : public Resource {
 public:
  // Returns a permanent failure status if the semaphore is indicating an
  ...
  // to the previous result of a QueryValue call and coherent with any waits for
  ...
  // QueryValue and Signal for the lifetime of the semaphore.
...
// DO NOT SUBMIT outstanding semaphores internal list?
// how to track
// for each semaphore:
//   query current value & expire resource sets
//   for each resource set + value pair:
//     if current value >= value:
//        release resource set
class OutstandingSemaphoreList {
 public:
};
